  ...
  function generateText(err) {
    ...
    async.each(
      ...
      function (table, _callback) {
        ...
        tableName = tableName
          .split("_")
          .map((lower) => lower.charAt(0).toUpperCase() + lower.substring(1))
        ...
        text[table] += spaces + spaces + "modelName: '" + tableName + "',\n";
...
AutoSequelize.prototype.write = function (
  ...
  // console.log("tables",self.tables.USER.ID.foreignKey);
...
function defineModel(self) {
  const db = self.tables;
  try {
    var text = `
